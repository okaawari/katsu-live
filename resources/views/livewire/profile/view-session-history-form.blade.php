...
<section>
    ...
    <div class="mt-6 space-y-6">
        ...
        @if ($activeSessionsCount >= 1)
            <div class="p-4 mb-4 text-sm text-yellow-800 dark:text-yellow-200 rounded-lg bg-yellow-50 dark:bg-yellow-900/50" role="alert">
        ...
        @if (count(auth()->user()->sessions) > 0)
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    ...
                    <tbody class="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700 rounded-md">
                            ...
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900 dark:text-gray-100">
                                    @if (!$session->is_current && !$session->logout_at)
                                        <button wire:click="endSession({{ $session->id }})" class="text-red-600 dark:text-red-400 hover:text-red-900 dark:hover:text-red-300">
                                            {{ __('Logout') }}
                                        </button>
                                    @endif
                                </td>
