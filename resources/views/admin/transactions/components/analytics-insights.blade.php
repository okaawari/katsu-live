    ...
    <div class="p-6">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <div class="space-y-4">
                ...
                <div class="space-y-3">
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-white">${{ number_format($premiumRevenue, 2) }}</span>
                    </div>
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="text-sm font-medium text-gray-900 dark:text-white">${{ number_format($vipRevenue, 2) }}</span>
                    </div>
                    
                    <div class="pt-2 border-t border-gray-200 dark:border-gray-700">
                        <div class="flex items-center justify-between">
                            <span class="text-sm font-semibold text-gray-700 dark:text-gray-300">Total</span>
                            <span class="text-sm font-semibold text-gray-900 dark:text-white">${{ number_format($subscriptionRevenue, 2) }}</span>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="space-y-4">
                ...
                @php
                    $thisMonth = \App\Models\PaymentHistory::whereMonth('transaction_date', now()->month)->sum('amount');
                    $lastMonth = \App\Models\PaymentHistory::whereMonth('transaction_date', now()->subMonth()->month)->sum('amount');
                ...
                <div class="space-y-3">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700 rounded-lg p-3">
                        <div class="flex items-center justify-between">
                            ...
                            <span class="text-sm font-medium text-gray-900 dark:text-white">${{ number_format($avgTransactionValue, 2) }}</span>
                        </div>
                    </div>
