...
async function updateRealTimeStats() {
    try {
        ...
        document.getElementById('todayRevenue').textContent = '$' + data.stats.total_revenue.toLocaleString('en-US', {minimumFractionDigits: 2});
        ...
        document.getElementById('avgOrderValue').textContent = '$' + data.stats.average_transaction.toLocaleString('en-US', {minimumFractionDigits: 2});
