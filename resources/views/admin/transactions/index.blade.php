                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Total Revenue</dt>
                                                         <dd class="text-lg font-medium text-gray-900 dark:text-white">₮{{ number_format($stats['total_revenue'], 0) }}</dd>
                    ...
                    <div class="ml-5 w-0 flex-1">
                        <dl>
                            <dt class="text-sm font-medium text-gray-500 dark:text-gray-400 truncate">Average Transaction</dt>
                                                         <dd class="text-lg font-medium text-gray-900 dark:text-white">₮{{ number_format($stats['average_transaction'], 0) }}</dd>
                        </dl>
                    </div>
                </div>
            </div>
                        ...
                        @foreach($topUsers as $index => $userRevenue)
                            <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700 rounded-lg">
                                ...
                                <div class="text-right">
                                             ...
                                             ₮{{ number_format($userRevenue->total_revenue, 0) }}
                                         </p>
                                </div>
                            </div>
                        @endforeach
